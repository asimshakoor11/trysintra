    ...
    (function( jQuery ){
  var $module = jQuery('#m-1688389219834').children('.module');
  ...
  if(mode == 'dev') {
    var moduleId = "1688389219834";
    var moduleIdSlug = moduleId.toString().replace(/-/g, '');
    if (moduleIdSlug == "1688389219834") {
      window.getTab1688389219834 = function() {
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1688389220343').children('.module');
  $module.gfV3Product();
})( window.GemQuery || jQuery );
    ...
    (function(jQuery) {
    var $module = jQuery('#m-1698247278990').children('.module');
    ...
    (function(jQuery) {
  var $module = jQuery('#m-1698247249536').children('.module');
  ...
  $module.gfV3ProductSwatches({
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1688389220343-3').children('.module');
...
(function( jQuery ){
  var $module = jQuery('#m-1698245951332').children('.module');
  $module.gfV3Product();
})( window.GemQuery || jQuery );
    ...
    (function( jQuery ){
  try {
    var $module = jQuery('#m-1688389220562').children('.module');   
    ...
    (function( jQuery ){
  // var $module = jQuery('#m-1688389220560').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
  
    (function( jQuery ){
  // var $module = jQuery('#m-1688389220563').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
  
    (function( jQuery ){
  // var $module = jQuery('#m-1688389220565').children('.module');
  // You can add custom Javascript code right here.
})( window.GemQuery || jQuery );
...
(function( jQuery ){
  var $module = jQuery('#m-1688389220605').children('.module');
  $module.gfV3Product();
})( window.GemQuery || jQuery );
...
(function( jQuery ){
  var $module = jQuery('#m-1688389220611').children('.module');
  $module.gfV3ProductCartButton({ onItemAdded: function(data) {}});
})( window.GemQuery || jQuery );
